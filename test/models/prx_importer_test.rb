    ...
    before {
      ...
      if use_webmock?
        ...
        stub_request(:put, "https://publish.pmp.io/docs/9ff6db7a-93e6-4987-9313-4d70d74051b2").
          with(:body => "{\"links\":{\"profile\":[{\"href\":\"https://api.pmp.io/profiles/property\",\"type\":\"application/vnd.collection.doc+json\"}],\"alternate\":[{\"href\":\"https://www.prx.org/group_accounts/45139\"}]},\"attributes\":{\"guid\":\"9ff6db7a-93e6-4987-9313-4d70d74051b2\",\"title\":\"The Moth\",\"tags\":[\"PRX\"],\"itags\":[\"prx_test\",\"prx:accounts-45139\"]}}").
