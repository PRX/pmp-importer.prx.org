...
describe PRXImporter do
  ...
  describe 'basic methods' do
    ...
    it 'creates a tag value for a prx object' do
      prx_importer.prx_tag('https://hal.prx.org/api/v1/foos/1').must_equal '_prx_foos__1_'
    end
  ...
  describe "imports into pmp" do
    ...
    before {
      ...
      if use_webmock?
        ...
        # find story by tag
        stub_request(:get, "https://api.pmp.io/docs?limit=1&tag=_prx_stories__87683_").
        ...
        # find account by tag
        stub_request(:get, "https://api.pmp.io/docs?limit=1&tag=_prx_accounts__45139_").
          to_return(:status => 200, :body => "", :headers => {})

        # create account
        stub_request(:put, "https://publish-sandbox.pmp.io/docs/9ff6db7a-93e6-4987-9313-4d70d74051b2").
          with(:body => "{\"links\":{\"profile\":[{\"href\":\"https://api.pmp.io/profiles/property\",\"type\":\"application/vnd.collection.doc+json\"}],\"alternate\":[{\"href\":\"https://www.prx.org/group_accounts/45139\"}]},\"attributes\":{\"guid\":\"9ff6db7a-93e6-4987-9313-4d70d74051b2\",\"title\":\"The Moth\",\"tags\":[\"prx_test\",\"PRX\",\"_prx_accounts__45139_\"]}}").
        ...
        # find series by tag
        stub_request(:get, "https://api.pmp.io/docs?limit=1&tag=_prx_series__32832_").
          to_return(:status => 200, :body => "", :headers => {})
        ...
        stub_request(:get, "https://api.pmp.io/docs?limit=1&tag=_prx_series_images__8696_").
          to_return(:status => 200, :body => "", :headers => {})

        # create image for series
        stub_request(:put, "https://publish-sandbox.pmp.io/docs/9ff6db7a-93e6-4987-9313-4d70d74051b4").
          with(:body => "{\"links\":{\"profile\":[{\"href\":\"https://api.pmp.io/profiles/image\",\"type\":\"application/vnd.collection.doc+json\"}],\"enclosure\":[{\"href\":\"https://hal.prx.org/pub/e56ce22b1bce78de79993ebcccf76611/0/web/series_image/8696/medium/WEEKLY_LOGO.jpg\",\"type\":\"image/jpeg\",\"meta\":{\"crop\":\"medium\"}}]},\"attributes\":{\"guid\":\"9ff6db7a-93e6-4987-9313-4d70d74051b4\",\"title\":\"\",\"byline\":\"\",\"tags\":[\"prx_test\",\"PRX\",\"_prx_series_images__8696_\"]}}").
        ...
        stub_request(:put, "https://publish-sandbox.pmp.io/docs/9ff6db7a-93e6-4987-9313-4d70d74051b3").
          with(:body => "{\"links\":{\"profile\":[{\"href\":\"https://api.pmp.io/profiles/series\",\"type\":\"application/vnd.collection.doc+json\"}],\"alternate\":[{\"href\":\"https://www.prx.org/series/32832\"}],\"item\":[{\"href\":\"https://api.pmp.io/docs/9ff6db7a-93e6-4987-9313-4d70d74051b4\",\"title\":\"\",\"rels\":[\"urn:collectiondoc:image\"]}]},\"attributes\":{\"guid\":\"9ff6db7a-93e6-4987-9313-4d70d74051b3\",\"title\":\"Moth Weekly Episodes for 2013\",\"tags\":[\"prx_test\",\"PRX\",\"_prx_series__32832_\"]}}").
        ...
        stub_request(:get, "https://api.pmp.io/docs?limit=1&tag=_prx_story_images__203874_").
          to_return(:status => 200, :body => "", :headers => {})

        # create image for story
        stub_request(:put, "https://publish-sandbox.pmp.io/docs/9ff6db7a-93e6-4987-9313-4d70d74051b5").
          with(:body => "{\"links\":{\"profile\":[{\"href\":\"https://api.pmp.io/profiles/image\",\"type\":\"application/vnd.collection.doc+json\"}],\"enclosure\":[{\"href\":\"https://hal.prx.org/pub/f8b82b49a679ab9a621791bc9b752ff2/0/web/story_image/203874/medium/Moth_ElnaBaker_1301.jpg\",\"type\":\"image/jpeg\",\"meta\":{\"crop\":\"medium\"}}]},\"attributes\":{\"guid\":\"9ff6db7a-93e6-4987-9313-4d70d74051b5\",\"title\":\"Elna Baker\",\"byline\":\"Elna Baker\",\"tags\":[\"prx_test\",\"PRX\",\"_prx_story_images__203874_\"]}}").
    ...
    it "imports a prx piece" do
      ...
      doc.title.must_equal "The Moth Radio Hour"
      doc.tags.sort.must_equal  ["PRX", "_prx_stories__87683_", "prx_test"]
